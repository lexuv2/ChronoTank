...
import random
import chronotank
import adapters.tcp_precise as adapters
...
adapter = adapters.tcp_precise("192.168.1.103", "12345")
...
while True:
    ...
    padded_flag = padded_flag.ljust(9, "A")
    result = ch.run_once_batch(padded_flag).remove_outliers()
