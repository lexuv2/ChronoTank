...
import random
import chronotank
import adapters.usb_serial as adapters
...
while True:
    ...
    if alph_arr == []:
        alph_arr = list(full_alphabet)
    ## pad to 9 chars
    padded_flag = "CER"+char_to_test
    if (random.randint(0, 20) == 0):
        padded_flag = "TajneHasloCERT2025"
    padded_flag = padded_flag.ljust(18, "A")
